...
{\HUGE Dielectric Elastomer Generators }\\[4mm]
{\Large \textit{Towards real-world applications}}\\
\rule[0.5ex]{\linewidth}{1pt}\vspace*{-\baselineskip}\vspace{3.2pt}
\rule[0.5ex]{\linewidth}{2pt}\\
\vspace{6.5mm}
{\large By}\\
\vspace{6.5mm}
{\large\textsc{Plinio Rodrigues de Oliveira Zanini}}\\
\vspace{11mm}
...
\end{minipage}\\
\vspace{9mm}
{\large\textsc{August 2018}}
\vspace{12mm}
\end{center}
\begin{flushright}
{\small Word count: UPDATE}
\end{flushright}
\end{adjustwidth*}
\end{SingleSpace}
\end{titlingpage}